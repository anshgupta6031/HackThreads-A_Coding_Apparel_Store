        ...
        <div>
            <section className="text-gray-600 body-font mt-32">
                <div className="container px-5 mx-auto">
                    {Object.keys(props.products).length === 0 && <p className='text-center'>Sorry! All the Sweatshirts are currently Out of Stock. New stock comming soon! Stay Tuned!</p>}
                        ...
                        {Object.keys(props.products).map((product) => {
                            return <Link key={props.products[product]._id} href={`/product/${props.products[product].slug}`}><div className="p-4 w-full shadow-lg">
                                ...
                                <div className="mt-4 text-center">
                                    <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Sweatshirts</h3>
