        ...
        <div className='container mt-28 w-[85%] m-auto mb-20'>
            ...
            <div className="px-2 w-full">
                <div class="mb-4">
                    ...
                    <textarea cols="30" rows="2" id="address" name="address" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
                </div>
            </div>
